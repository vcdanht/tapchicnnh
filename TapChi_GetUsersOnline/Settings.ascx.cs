...
namespace TapChi.Modules.TapChi_GetUsersOnline
{
    ...
    /// 
    /// Because the control inherits from TapChi_GetUsersOnlineSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : TapChi_GetUsersOnlineModuleSettingsBase
    {
