<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View.ascx.cs" Inherits="TapChi.Modules.TapChi_GetUsersOnline.View" %>
<div class="dnn_FooterLegal_Left">
<asp:Label ID="lblUserOnline" runat="server"/><br />
<asp:Label ID="lblUserAccess" runat="server"/>
